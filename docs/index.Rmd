...
## Estimador
 - Para encontramos o EMV, só precisamos derivar $\ell_t(\boldsymbol{\theta},y_t)$ e iguala-la a zero, no nosso caso teremos dificuldades algébrica, então usaremos métodos computacionais, como a derivada a baixo:
